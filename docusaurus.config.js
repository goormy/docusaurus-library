		...
		[
			...
			({
				docs: {
					...
					editUrl:
						'https://github.dev/goormy/docusaurus-library/blob/master',
				},
				blog: {
				...
				items: [
					...
					},
					{
						...
						items: [
							{
								type: 'docSidebar',
								sidebarId: 'merryLecturesSidebar',
								label: 'merry',
							},
							{
								type: 'docSidebar',
								sidebarId: 'irangLecturesSidebar',
								label: 'irang',
							},
							{
								type: 'docSidebar',
								sidebarId: 'jadeLecturesSidebar',
								label: 'jade',
							},
						],
						position: 'left',
